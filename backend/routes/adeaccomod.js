...
router.post('/addaccomodation', fetchuser, [
  ...
  body('photos', 'Enter a valid photo URL').isURL(),
  ...
  try {
    ...
    const { propertyName, address, photos, description, propertyType, roomType, amenities, moreInfo, checkInTime, checkOutTime, maxGuests, price } = req.body;
